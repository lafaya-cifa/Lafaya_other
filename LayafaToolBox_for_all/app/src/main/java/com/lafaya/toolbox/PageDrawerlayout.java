...
public class PageDrawerlayout {
    ...
    private LinearLayout drawerlayout_doorinfo;
    ...
    public void activityDrawerlayout(final Activity activity,final Handler handler){
        ...
        drawerlayout_doorinfo = (LinearLayout)activity.findViewById(R.id.drawerlayout_doorinfo);
   ...
   public void UpdateDrawerlayout(){
       ...
       if(MainActivity.doorStatus.doortype == MainActivity.doorStatus.TYPE_REVOLVINGDOOR){
          layout_switch_menu_light.setVisibility(View.VISIBLE);
           layout_switch_menu_lock.setVisibility(View.VISIBLE);
           drawerlayout_doorinfo.setVisibility(View.VISIBLE);
       }else {
           if(MainActivity.doorStatus.doortype == MainActivity.doorStatus.TYPE_SWITCH){
               drawerlayout_doorinfo.setVisibility(View.GONE);
           }else {
               drawerlayout_doorinfo.setVisibility(View.VISIBLE);
           }
