...
//    public static char sendrightwingID  =0x26;
    ...
    public static char switchsend_ID = 0x42;
    public static char switchreceive_ID = 0x24;
...
//    public static char receiverightwingID  =0x62;
    ...
    private char cmd_switchinit = 0x51;
    //公共命令
    ...
    private void ReceiveLafayaProcess(char[] data) {
        //判断命令
        if(data[0] == switchreceive_ID){

            if(data[1] == cmd_switchinit){
                MainActivity.pageHomelayout.receiveStatus();
            }else if(data[1] == cmd_opendoor){

            }
        }
        else if(data[1] == cmd_info){
